    ...
    <div class="list__item" v-for="book in books" :key="book.id">
      <div class="item__block">
        <div class="item__title">
          <h4>
            Title: <span class="text_medium">{{ book.title }}</span>
          </h4>
        </div>
        <div class="item__author">
          <h4>
            Author:
            <span class="text_medium">{{ getAuthorName(book.authorId) }}</span>
          </h4>
        </div>
        ...
        <div class="item__date">
          <h4>
            Publication date:
            <span class="text_medium">{{ book.dateofpublication }}</span>
          </h4>
        </div>
        <h4>Description:</h4>
...
export default {
        ...
        mounted() {
            ...
            this.$store.dispatch('booksStore/getBooks', authorId, { root: true })
